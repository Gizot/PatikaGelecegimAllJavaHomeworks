## Aşağıdaki problem ifadesine göre bir sınıf diyagramı tasarlayalım
...
* Klasör içindeki ElevatorSimulation.png dosyasından ilgili proje çalışmasına erişebilirsiniz. 